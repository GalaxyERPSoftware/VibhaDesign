...
const Addproduct = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            formData.append('SubCategory_Id', formData.SubCategory_Id);
            formData.append('Quantity', formData.Quantity);
            formData.append('Rate', formData.Rate);
            ...
            // try {
            //     const res = await axios.post(`${process.env.REACT_APP_API_BASE_URL}/api/addproduct`, data);
            //     alert("Product added successfully!");
            //     console.log(res.data);

            await axios.post(`${API_BASE_URL}/api/addproduct`, formData);
